...
<section class="about">
   ...
   <div class="content">
      <h3>why choose us?</h3>
      <p>Since online travel agencies make bookings in bulk, they are able to offer you rates that you probably won’t find anywhere else. They have tie-ups with hotel chains that allow them to offer special package deals and add-ons for customers. But that’s not it. Allow us to let you in on a little secret—did you know that you are likely to be offered a special (read: lower) price if you are logged in to a travel app? Yes, you heard that right! The price shown to you on a travel website or app may significantly drop if you create an account and sign in. There couldn’t be an easier way to bag a dreamy hotel deal.</p>
      <!-- <p></p> -->
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="#"> <i class="fas fa-envelope"></i> tknmmproject@gmail.com </a>
